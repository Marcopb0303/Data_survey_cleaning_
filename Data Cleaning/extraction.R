...
crew_data_2025 <- readRDS("crew_dataset_keys_analysis_ready.rds")
names(crew_data_2025)
view(crew_data_2025)

unique_words <- unique(unlist(paste(crew_data_2025$"m25", collapse = " "), "\\W+"))
print(unique_words)
unique_words <- unique(unlist(strsplit(paste(crew_data_2025$"WHEREFROM", collapse = " "), "\\W+")))
print(unique_words)
unique_words <- unique(unlist(strsplit(paste(crew_data_2025$"G20Q70", collapse = " "), "\\W+")))
print(unique_words)
unique_words <- unique(unlist(strsplit(paste(crew_data_2025$"m27", collapse = " "), "\\W+")))
print(unique_words)
unique_words <- unique(unlist(paste(crew_data_2025$"m28A", collapse = " "), "\\W+"),)
print(unique_words)
unique_words <- unique(unlist(strsplit(paste(crew_data_2025$"i0[3]", collapse = " "), "\\W+")))
print(unique_words)

unique(crew_data_2025$"m12A[SQ001]")
unique(crew_data_2025$"m12A[SQ002]")
unique(crew_data_2025$"m12A[SQ003]")
unique(crew_data_2025$"m12A[SQ004]")
unique(crew_data_2025$"m2B[SQ005]")
unique(crew_data$"G10Q78")
unique(crew_data$"m27")